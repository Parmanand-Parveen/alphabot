      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        {data.map((item, index) => (
          <div key={index} className="flex justify-start pt-10 md:pt-40 md:gap-10">
            <div
              ...
              <div
                className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-white dark:bg-[#0A0A0A] flex items-center justify-center">
                <div
        ...
        <div
          ...
          <motion.div
            ...
            className="absolute inset-x-0 top-0  w-[2px] bg-gradient-to-t from-[#F4A460] via-[#8B4513] to-transparent from-[0%] via-[10%] rounded-full" />
        </div>
      </div>
    </div>)
  );
